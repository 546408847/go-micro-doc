...
type DemoService interface {
	Hello(ctx context.Context, in *NameRequest, opts ...client.CallOption) (*HelloResponse, error)
}
...
func (c *demoService) Hello(ctx context.Context, in *NameRequest, opts ...client.CallOption) (*HelloResponse, error) {
...
func RegisterDemoHandler(s server.Server, hdlr DemoHandler, opts ...server.HandlerOption) error {
	type demo interface {
		Hello(ctx context.Context, in *NameRequest, out *HelloResponse) error
	}
	type Demo struct {
		demo
	}
...
func (h *demoHandler) Hello(ctx context.Context, in *NameRequest, out *HelloResponse) error {
